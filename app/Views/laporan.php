...
<div class="card">
    <div class="card-header">
        <div class="row align-items-center">
            ...
            <div class="col-lg-2">
                <button class="btn btn-primary" onclick="menuCetak()">Cetak</button>
            </div>
...
<script>
    function cetak() {
        // Tambahkan logika cetak yang sesuai di sini
        // Misalnya, memanggil fungsi cetak yang sudah Anda miliki sebelumnya
        // atau menampilkan dialog cetak menggunakan JavaScript

        // Contoh: memanggil fungsi cetak yang sudah Anda miliki sebelumnya
        // cetak();

        // Contoh: menampilkan dialog cetak menggunakan JavaScript
        window.print();
    }
</script>
